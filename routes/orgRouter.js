...
import { createOrgController, orgListController, getSingleOrgController} from '../controllers/orgControllers.js'
...
orgRouter
  ...
  .post(isValidTokenController, createOrgController)// Protected - user can create their own org
